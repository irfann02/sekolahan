        ...
        <div class="card">
          ...
          <table class="table table-bordered" cellpadding="5" width="100%">
              ...
              <tr align="center">
                ...
                <td>
                <a href="/edit-jadwal/{{ $j->id }}"><i class="fas fa-edit"></i></a> | <a href="/delete-jadwal/{{ $j->id }}"><i class="fas fa-trash-alt" style="color: red;"></i></a>
                </td>
              </tr>
              @endforeach
            </table>
            <br>
            <a href="/create-jadwal" class="btn btn-success">Tambah Data <i class="fas fa-plus-circle"></i> </a>
          </div>
